...
Artist.create(name: "Carter Hulsey", password: "password", password_confirmation: "password", website_url: "carterhulsey.com", email: "carter@gmail.com", city: "Joplin", state: "MO", featured: true)
